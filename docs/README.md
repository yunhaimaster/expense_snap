...
2. Study [KNOWLEDGE_BASE.md](./KNOWLEDGE_BASE.md) for architecture
3. Reference [API.md](./API.md) when coding

### For AI Assistants

1. Read [PROJECT_INDEX.md](../PROJECT_INDEX.md) first (mandatory)
2. Check [CLAUDE.md](../CLAUDE.md) for conventions
3. Reference [openspec/](../openspec/) for feature specs

### For Troubleshooting

1. Check [KNOWLEDGE_BASE.md#troubleshooting](./KNOWLEDGE_BASE.md#troubleshooting)
...
2. Update [PROJECT_INDEX.md](../PROJECT_INDEX.md) if structure changes
3. Update [openspec/](../openspec/) if features change
